...
!(function(t, e) {
    ...
    function b(t, i) {
        ...
        const l = {top: t.scrollTop, height: i.railYHeight};
    ...
    var W = function(t, e, i, r, l) {
            ...
            (t.containerWidth = e.clientWidth),
                ...
                !t.settings.suppressScrollY && t.containerHeight + t.settings.scrollYMarginOffset < t.contentHeight
                    ? ((t.scrollbarYActive = !0),
                      ...
                      (t.scrollbarYTop = u(
                          (e.scrollTop * (t.railYHeight - t.scrollbarYHeight)) / (t.contentHeight - t.containerHeight),
                      )))
        ...
        R = {
            ...
            keyboard(t) {
                ...
                t.event.bind(t.ownerDocument, 'keydown', function(r) {
                    if (!((r.isDefaultPrevented && r.isDefaultPrevented()) || r.defaultPrevented) && (l() || n())) {
                        ...
                        (t.settings.suppressScrollX && s !== 0) ||
                            (t.settings.suppressScrollY && a !== 0) ||
            ...
            wheel(e) {
                function i(t, i) {
                    const r = o.scrollTop === 0;
                    const l = o.scrollTop + o.offsetHeight === o.scrollHeight;
                    const n = o.scrollLeft === 0;
                    const s = o.scrollLeft + o.offsetWidth === o.offsetWidth;
                ...
                function r(t) {
                    ...
                    return (
                        ...
                        t.deltaMode && t.deltaMode === 1 && ((e *= 10), (i *= 10)),
            ...
            touch(e) {
                ...
                function n(t) {
                    return !(
                        (t.pointerType && t.pointerType === 'pen' && t.buttons === 0) ||
                        ((!t.targetTouches || t.targetTouches.length !== 1) &&
                            (!t.pointerType || t.pointerType === 'mouse' || t.pointerType === t.MSPOINTER_TYPE_MOUSE))
                    );
                }
                function o(t) {
                    if (n(t)) {
                ...
                function a(t) {
                    if (n(t)) {
                        const e = l(t);
                        const o = {pageX: e.pageX, pageY: e.pageY};
                        const a = o.pageX - u.pageX;
                        const c = o.pageY - u.pageY;
        ...
        H = function(r, l) {
            ...
            if (
                (void 0 === l && (l = {}), typeof r == 'string' && (r = document.querySelector(r)), !r || !r.nodeName)
            ) {
            ...
            (this.isRtl = t(r).direction === 'rtl'),
                (this.isNegativeScroll = (function() {
                    const t = r.scrollLeft;
                    let e = null;
...
!(function(a, b) {
    ...
    return (
        ...
        (e.prototype = {
            ...
            unpin() {
                ...
                (!a.contains(b.pinned) && a.contains(b.unpinned)) ||
                    (a.add(b.unpinned), a.remove(b.pinned), this.onUnpin && this.onUnpin.call(this));
            },
            pin() {
                const a = this.elem.classList;
                const b = this.classes;
            ...
            bottom() {
                ...
                a.contains(b.bottom) ||
                    (a.add(b.bottom), a.remove(b.notBottom), this.onBottom && this.onBottom.call(this));
            },
            notBottom() {
                const a = this.elem.classList;
                const b = this.classes;
                ...
                a.contains(b.notBottom) ||
                    (a.add(b.notBottom), a.remove(b.bottom), this.onNotBottom && this.onNotBottom.call(this));
            },
            getScrollY() {
            ...
            isOutOfBounds(a) {
                const b = a < 0;
                const c = a + this.getScrollerPhysicalHeight() > this.getScrollerHeight();
        ...
        (e.cutsTheMustard = typeof f != 'undefined' && f.rAF && f.bind && f.classList),
        e
    );
});
...
!(function(e, t) {
        ...
        w.extend({
            ...
            isPlainObject(e) {
                ...
                return (
                    ...
                    (!(t = i(e)) ||
                        (typeof (n = f.call(t, 'constructor') && t.constructor) == 'function' && p.call(n) === d))
                );
            },
            isEmptyObject(e) {
                let t;
    ...
    function C(e) {
        const t = Boolean(e) && 'length' in e && e.length;
        const n = x(e);
    ...
    const E = (function(e) {
        ...
        let m;
        let x;
        const b = 'sizzle' + Number(new Date());
        const w = e.document;
        let T = 0;
        let C = 0;
        const E = ae();
        ...
        const G = /^(?:input|select|textarea|but{2}on)$/i;
        const Y = /^h\d$/i;
        const Q = /^[^{]+{\s*\[native \w/;
        const J = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/;
        const K = /[+~]/;
        ...
        (n = oe.support = {}),
            ...
            ((r = oe.selectors = {
                ...
                preFilter: {
                    ...
                    CHILD(e) {
                        return (
                            ...
                            e[1].slice(0, 3) === 'nth'
                                ? (e[3] || oe.error(e[0]),
                                  (e[4] = Number(e[4] ? e[5] + (e[6] || 1) : 2 * (e[3] === 'even' || e[3] === 'odd'))),
                ...
                filter: {
                    ...
                    PSEUDO(e, t) {
                        let n;
                        const i = r.pseudos[e] || r.setFilters[e.toLowerCase()] || oe.error('unsupported pseudo: ' + e);
    ...
    ((w.fn.init = function(e, t, n) {
        ...
        (q = w(r));
    const H = /^(?:parents|prev(?:Until|Al{2}))/;
    ...
    function te(e) {
        return (
            e === 'true' ||
            (e !== 'false' &&
                (e === 'null' ? null : e === String(Number(e)) ? Number(e) : Z.test(e) ? JSON.parse(e) : e))
        );
    }
    function ne(e, t, n) {
        let r;
    ...
    function ue(e, t, n, r) {
        ...
        let c = (w.cssNumber[t] || (l !== 'px' && Number(u))) && ie.exec(w.css(e, t));
    ...
    !(function() {
        ...
        t.setAttribute('type', 'radio'),
            ...
            (h.noCloneChecked = Boolean(e.cloneNode(!0).lastChild.defaultValue));
    })();
    ...
    const Ne = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\s\0/>]*)[^>]*)\/>/gi;
    const je = /checked\s*(?:[^=]|=\s*.checked.)/i;
    const qe = /^\s*<!(?:\[CDATA\[|-{2})|(?:]{2}|-{2})>\s*$/g;
    ...
    (w.Tween = tt),
        ...
        (w.fx.step = {});
    const it = /^(?:tog{2}le|show|hide)$/;
    let nt;
    const ot = /q(?:ue){2}Ho{2}ks$/;
    let rt;
    ...
    const gt = /^(?:input|select|textarea|but{2}on)$/i;
    const yt = /^(?:a|area)$/i;
    ...
    const Dt = /\r?\n/g;
    const Nt = /^(?:submit|but{2}on|image|reset|file)$/i;
    const St = /\[]$/;
    ...
    const Ht = /([&?])_=[^&]*/;
    const Ot = /^(.*?):[\t ]*([^\n\r]*)$/gm;
    const Pt = /^(?:about|ap{2}|ap{2}-storage|.+-extension|file|res|widget):$/;
    const Mt = /^(?:GET|HEAD)$/;
    const Rt = /^\/{2}/;
    const It = {};
    const Wt = {};
    ...
    w.extend({
        ...
        ajax(t, n) {
            ...
            if (
                (v.promise(E),
                (h.url = String(t || h.url || Ct.href).replace(Rt, Ct.protocol + '//')),
            ...
            if (
                (h.data && h.processData && typeof h.data != 'string' && (h.data = w.param(h.data, h.traditional)),
                _t(It, h, n, E),
                c)
            ) {
                return E;
    ...
    (h.cors = Boolean(Gt) && 'withCredentials' in Gt),
        (h.ajax = Gt = Boolean(Gt)),
                ...
                return {
                    send(i, o) {
                        ...
                        (n = function(e) {
                            return function() {
                                n &&
                                    ((n = r = s.addEventListener(
                                        ...
                                        s.addEventListener(
                                            'error',
                                            s.addEventListener('abort', (s.ontimeout = s.onreadystatechange = null)),
                                        ),
                                    )),
                                    e === 'abort'
                                        ? s.abort()
                            ...
                            (r = s.addEventListener('error', (s.ontimeout = n('error')))),
                            void 0 !== s.onabort
